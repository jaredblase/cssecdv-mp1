...
public class Frame extends javax.swing.JFrame {
    ...
    private void adminBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminBtnActionPerformed
        if (adminActionListener != null) {
            adminActionListener.actionPerformed(evt);
        }
    }//GEN-LAST:event_adminBtnActionPerformed

    private void managerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managerBtnActionPerformed
        if (managerActionListener != null) {
            managerActionListener.actionPerformed(evt);
        }
    }//GEN-LAST:event_managerBtnActionPerformed

    private void staffBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_staffBtnActionPerformed
        if (staffActionListener != null) {
            staffActionListener.actionPerformed(evt);
        }
    }//GEN-LAST:event_staffBtnActionPerformed

    private void clientBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientBtnActionPerformed
        if (clientActionListener != null) {
            clientActionListener.actionPerformed(evt);
        }
    }//GEN-LAST:event_clientBtnActionPerformed

    private void logoutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutBtnActionPerformed
        if (logoutActionListener != null) {
            logoutActionListener.actionPerformed(evt);
        }
    }//GEN-LAST:event_logoutBtnActionPerformed

    public void init() {
        this.container.add(HomePnl, Panel.HOME.name());
    ...
    public void setManagerActionListener(ActionListener managerActionListener) {
        this.managerActionListener = managerActionListener;
    }

    public void setStaffActionListener(ActionListener staffActionListener) {
        this.staffActionListener = staffActionListener;
    }

    public void setClientActionListener(ActionListener clientActionListener) {
        this.clientActionListener = clientActionListener;
    }

    public void setLogoutActionListener(ActionListener logoutActionListener) {
